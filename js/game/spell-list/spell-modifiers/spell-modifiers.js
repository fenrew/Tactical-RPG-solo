function calculatePhysicalMeleeDamageModifiers(caster, target) {
  let casterMod = caster.class.modifiers.offensive;
  let targetMod = target.class.modifiers.defensive;

  let meleeDamageModifier =
    (casterMod.allDamage +
      casterMod.physicalDamage.allDamage +
      casterMod.physicalDamage.meleeDamage -
      2) *
    (targetMod.allDamage +
      targetMod.physicalDamage.allDamage +
      targetMod.physicalDamage.meleeDamage -
      2);
...
function calculatePhysicalRangedDamageModifiers(caster, target) {
  ...
  let rangedDamageModifier =
    (casterMod.allDamage +
      casterMod.physicalDamage.allDamage +
      casterMod.physicalDamage.rangedDamage -
      2) *
    (targetMod.allDamage +
      targetMod.physicalDamage.allDamage +
      targetMod.physicalDamage.rangedDamage -
      2);
...
function calculateHealingModifiers(caster, target) {
  let casterMod = caster.class.modifiers.healing;
  let targetMod = target.class.modifiers.healing;

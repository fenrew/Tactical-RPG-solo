...
function addSpellListKeysToElement(spellList, element){
    console.log(Game.combatTimeline[Game.turn].class.combatstats)
    ...
    spellListArray.forEach((spell) => {
        ...
        spell.spellInfo.manaCost > currentMana ? newContainerEle.classList.add("insufficient-mana") : ""
